...
* add waitUntil and waitForSelctor to linksBuilder ([#2437](https://github.com/BndktCG/streetmerchant/issues/2437)) ([cac7c20](https://github.com/BndktCG/streetmerchant/commit/cac7c20193caaec5d41291104e66aa01a65adceb))
...
* **nvidia:** updated store for europe ([#1732](https://github.com/BndktCG/streetmerchant/issues/1732)) ([2143b15](https://github.com/BndktCG/streetmerchant/commit/2143b158090dc065a29bdde4c6dc592a5a745c07))
...
* **store:** add materiel.net (french), 35 3060ti references ([#2287](https://github.com/BndktCG/streetmerchant/issues/2287)) ([0ebe745](https://github.com/BndktCG/streetmerchant/commit/0ebe7451e4e4c6e46c64e3782bd51a92ce594dca))
...
* **vsgamers:** add maxPrice selector([#1682](https://github.com/BndktCG/streetmerchant/issues/1682)) ([84382de](https://github.com/BndktCG/streetmerchant/commit/84382def6f23b1e8b1ad8c14fb4f423f32a35eb7))
...
* **bestbuy-ca:** avoid false positive ([#2694](https://github.com/BndktCG/streetmerchant/issues/2694)) ([0c589a7](https://github.com/BndktCG/streetmerchant/commit/0c589a71f259c80ff21a4bb623f9316cb7702a61))
...
* **lookup:** prevent terminal from being hidden ([#2461](https://github.com/BndktCG/streetmerchant/issues/2461)) ([39fac90](https://github.com/BndktCG/streetmerchant/commit/39fac90ba4feadb7e5c681db60e60a83749f5e62))
...
* **store:** update out of stock detection for MediaMarkt and Saturn ([#1549](https://github.com/BndktCG/streetmerchant/issues/1549)) ([4f86d24](https://github.com/BndktCG/streetmerchant/commit/4f86d2462e5d1eba6a7d7839585c0fe8c1b70da5)), closes [#1545](https://github.com/BndktCG/streetmerchant/issues/1545)
...
* **amd:** update rx6900xt urls ([#2876](https://github.com/BndktCG/streetmerchant/issues/2876)) ([88ec46e](https://github.com/BndktCG/streetmerchant/commit/88ec46e2f8e3aa0ccc4af3ecddf2311c31c0509c))
...
* **deps-dev:** bump @types/node from 14.14.14 to 14.14.16 ([#1506](https://github.com/BndktCG/streetmerchant/issues/1506)) ([e893d79](https://github.com/BndktCG/streetmerchant/commit/e893d79ad781ba5d8b43bcbfc6b8676dfbf8225a))
...
* **deps-dev:** bump webpack from 5.11.0 to 5.11.1 ([#1541](https://github.com/BndktCG/streetmerchant/issues/1541)) ([6a4049b](https://github.com/BndktCG/streetmerchant/commit/6a4049bbc3ec2e499e3a3279e4d0f01397924a07))
...
* **deps:** bump actions/setup-python from 2 to 3 ([#2965](https://github.com/BndktCG/streetmerchant/issues/2965)) ([fe53ba3](https://github.com/BndktCG/streetmerchant/commit/fe53ba34ba31d99e36d64d210ad4fa95baa2ea38))
...
* **deps:** bump GoogleCloudPlatform/release-please-action from v2.10 to v2.12.2 ([#1339](https://github.com/BndktCG/streetmerchant/issues/1339)) ([769f19e](https://github.com/BndktCG/streetmerchant/commit/769f19efa2a73b24d4a81f400e8c696eb6424df5))
...
* **deps:** bump twilio from 3.54.1 to 3.54.2 ([#1622](https://github.com/BndktCG/streetmerchant/issues/1622)) ([1ed8eca](https://github.com/BndktCG/streetmerchant/commit/1ed8eca6f9a3430cb86aa4ba02dddea525d0dfe8))
...
* **globaldata:** add 3060, 3060ti, amd ([#2044](https://github.com/BndktCG/streetmerchant/issues/2044)) ([11e1465](https://github.com/BndktCG/streetmerchant/commit/11e14655e1c7a8022bebea2f76cc94ba903b29d8))
...
* **notification:** add better logging, remove debug ([d12639e](https://github.com/BndktCG/streetmerchant/commit/d12639ee8561240d99ef5c2c364255ff808f78b0))
...
* **store:** add some PS5 bundles ([#2021](https://github.com/BndktCG/streetmerchant/issues/2021)) ([d4dc397](https://github.com/BndktCG/streetmerchant/commit/d4dc397e9a848d6d2ba1ed56188fb0ddda98e795))
...
* update bestbuy selectors ([#3186](https://github.com/BndktCG/streetmerchant/issues/3186)) ([810cefc](https://github.com/BndktCG/streetmerchant/commit/810cefcd56129448d485127064478b985acb992b))
* update bug template ([53cb59a](https://github.com/BndktCG/streetmerchant/commit/53cb59aada47775b2ab48a1e0e94d2271424a609))
* update dependencies ([f14a1ca](https://github.com/BndktCG/streetmerchant/commit/f14a1ca76e41943e639e08a9c8a6299dfa362d9d))
* update dependencies ([1d08d4c](https://github.com/BndktCG/streetmerchant/commit/1d08d4c12292e1b98ad952fa4f88c1965fa7bd6a))
* update dependencies ([8d5792b](https://github.com/BndktCG/streetmerchant/commit/8d5792bf9e377f10d2c156923162d339ef356fc8))
* update dependencies and nightly workflow ([3b43732](https://github.com/BndktCG/streetmerchant/commit/3b43732f291d263792585fa05264dcf322b55620))
* update logos ([2a5e2e8](https://github.com/BndktCG/streetmerchant/commit/2a5e2e873362000ab8c5cdef2c57b6fdb3574ec9))
* update package-lock, remove ci perms ([#3059](https://github.com/BndktCG/streetmerchant/issues/3059)) ([ba98f26](https://github.com/BndktCG/streetmerchant/commit/ba98f2653ea865cc0c08687b05277566cfc1db32))
* update pr template ([f0e5c5d](https://github.com/BndktCG/streetmerchant/commit/f0e5c5d17bad282480da30cc68e5bd8eb9d80844))
* update stale workflow ([e4a267f](https://github.com/BndktCG/streetmerchant/commit/e4a267f675800b04d06ddb4212de1373a767a113))
* update template, typos in docs ([#1386](https://github.com/BndktCG/streetmerchant/issues/1386)) ([d592cd5](https://github.com/BndktCG/streetmerchant/commit/d592cd5d77452363188e69aeaa94e57417f48135))
* **walmart:** update 5900x url ([#2184](https://github.com/BndktCG/streetmerchant/issues/2184)) ([b2ce715](https://github.com/BndktCG/streetmerchant/commit/b2ce7157d9631d6edd45debcb9ab85bc79241133))
* **xbox:** update oos selector ([4d89306](https://github.com/BndktCG/streetmerchant/commit/4d8930616d2296fcdd6c0d79bac2109f1388a0b0)), closes [#2118](https://github.com/BndktCG/streetmerchant/issues/2118) [#2479](https://github.com/BndktCG/streetmerchant/issues/2479) [#2475](https://github.com/BndktCG/streetmerchant/issues/2475) [#2200](https://github.com/BndktCG/streetmerchant/issues/2200)


### Continuous Integration

* add workflow_dispatch for quick releases ([064ce83](https://github.com/BndktCG/streetmerchant/commit/064ce83f03c736d1baf6c55da6e5d1edfa380f24))
* bump node-version ([40c4a8c](https://github.com/BndktCG/streetmerchant/commit/40c4a8c1b9e50cf94f7a595aa78a4802d2fa981d))
* change check-date name ([812dc5e](https://github.com/BndktCG/streetmerchant/commit/812dc5ea8d9830c251a526c02de05a15bfe20602))
* change pr linter ([1c113ef](https://github.com/BndktCG/streetmerchant/commit/1c113efc423de994456411e04485eec414aaef78))
* checkout when publish ([a5c0ed8](https://github.com/BndktCG/streetmerchant/commit/a5c0ed8d9f22169649d700c1d7d02b18cdf658d6))
* don't need to run on main ([#2792](https://github.com/BndktCG/streetmerchant/issues/2792)) ([4da5200](https://github.com/BndktCG/streetmerchant/commit/4da5200b5a6e85e11d96f320f658e8f5f9a0a70c))
* fix cache ([e1b4320](https://github.com/BndktCG/streetmerchant/commit/e1b43206fcf037c140e507bb4d08c72248d76dcc))
* fix checkout and names ([6c2ca19](https://github.com/BndktCG/streetmerchant/commit/6c2ca198b6d5b114e8146c1e15fe87324aec4f8f))
* fix docker release ([c2a2271](https://github.com/BndktCG/streetmerchant/commit/c2a22716cce0de6cbdbfdf7ebdceb97844a22e0f))
* fix documentation ([ebf8b20](https://github.com/BndktCG/streetmerchant/commit/ebf8b20071dc628b1f47b96ee2b03f888c056dd9))
* fix if statement ([560e614](https://github.com/BndktCG/streetmerchant/commit/560e61414a6a5ea3856f34905a470bdbc262d135))
* fix needs output ref ([305e8f0](https://github.com/BndktCG/streetmerchant/commit/305e8f0fb237306705a481266ecedf841f57192a))
* fix needs ref ([557cde4](https://github.com/BndktCG/streetmerchant/commit/557cde46367576e9ca6a9e207f3bc80be630b960))
* fix nightly ([52b5e5e](https://github.com/BndktCG/streetmerchant/commit/52b5e5e79ac381b585ec1dd63288aefe4f9da9d1))
* fix nightly release ([5f81a8a](https://github.com/BndktCG/streetmerchant/commit/5f81a8a25f60788d1c529078aab89675d6b5ffc3))
* fix permissions and steps ([5551f78](https://github.com/BndktCG/streetmerchant/commit/5551f78365971829137eb2a062de08996b7c7bdf))
* fix pr lint trigger ([9e8c836](https://github.com/BndktCG/streetmerchant/commit/9e8c83622d130c4adfc90e7388b7d79f380800fa))
* fix release-please ([7997d6d](https://github.com/BndktCG/streetmerchant/commit/7997d6d22a6a3469adeef798d6bf5b66fb055101))
* fix tags ([e67a383](https://github.com/BndktCG/streetmerchant/commit/e67a3838e195b0e6c3039546f6e48d30e291fd6a))
* give tag an output ([36771fd](https://github.com/BndktCG/streetmerchant/commit/36771fd55539c17b7fb589b2e5811644e62916fa))
* pin version to major ([2c3c47b](https://github.com/BndktCG/streetmerchant/commit/2c3c47b4a92a25513c2a7f3fdf5fb02a7857de1f))
* quote tags ([9ce7dac](https://github.com/BndktCG/streetmerchant/commit/9ce7dac951552d239c83e56bebadbfa22ae02110))
* remove fetch-depth ([c21d412](https://github.com/BndktCG/streetmerchant/commit/c21d412ed5959bd7a0a56a6dcf624ff9e6c2dac8))
* replace runs with run ([9ec2018](https://github.com/BndktCG/streetmerchant/commit/9ec2018d58438897cb7ed01157433536171754ae))
* rerun pr lint if synced ([659edcd](https://github.com/BndktCG/streetmerchant/commit/659edcd421c97abe650ddd3d61fbd345f2727fee))
* revert username ([2d702b3](https://github.com/BndktCG/streetmerchant/commit/2d702b32b4ea370d27071f4ffa833c3c0ac8cc88))
* run ci on main ([e8ee59f](https://github.com/BndktCG/streetmerchant/commit/e8ee59fae16b08deaf3d83549c9a803fe97a582c))
* test code check ([#3058](https://github.com/BndktCG/streetmerchant/issues/3058)) ([245ade7](https://github.com/BndktCG/streetmerchant/commit/245ade7e15625cefa5862c9708fdefcce1bd9df3))
* update changelog-types ([0a8334a](https://github.com/BndktCG/streetmerchant/commit/0a8334aa440e3e6acfbb9cfe392c72af36a391bf))
* update names and steps ([#1720](https://github.com/BndktCG/streetmerchant/issues/1720)) ([8ece4b6](https://github.com/BndktCG/streetmerchant/commit/8ece4b641229d16fd7d453e3f7cca40e8dde4373))
* update naming ([5d3ca2e](https://github.com/BndktCG/streetmerchant/commit/5d3ca2ead9e93384436948b9ef60d377b2bccf34))
* update pr lint ([e527e43](https://github.com/BndktCG/streetmerchant/commit/e527e43e85034df6e2852d61fb7909e6f1949763))
* update pr lint secret ([7cf60f8](https://github.com/BndktCG/streetmerchant/commit/7cf60f84e1ca1c87ec7c6ba6ae24c89af31097ce))
* update pr linter ([25d556c](https://github.com/BndktCG/streetmerchant/commit/25d556c736a90b64f4312e4a4332dbc922b71f66))
* update release-please ([704fa39](https://github.com/BndktCG/streetmerchant/commit/704fa393c2bd22809b0eb7b12a05e82afe6bd090))
* update stale labels ([b412146](https://github.com/BndktCG/streetmerchant/commit/b4121463ed7f25566cfa4ff508fa0c4d03237a9d))
* update verbiage for steps ([#1721](https://github.com/BndktCG/streetmerchant/issues/1721)) ([05720e5](https://github.com/BndktCG/streetmerchant/commit/05720e519bd0482ddb7c96bb954832e4e5e02973))
* use github actor ([cf83753](https://github.com/BndktCG/streetmerchant/commit/cf83753853344a328379f0b3f101a26957254096))
* use github token ([27dc9d2](https://github.com/BndktCG/streetmerchant/commit/27dc9d220ccc9ea98976ec271c526d72c8724b9a))
* use single quotes ([bfc5bfd](https://github.com/BndktCG/streetmerchant/commit/bfc5bfd29f0034e99a7d2f006cd480401c0cfd35))


### Documentation

* add better heroku documentation ([#2942](https://github.com/BndktCG/streetmerchant/issues/2942)) ([f344615](https://github.com/BndktCG/streetmerchant/commit/f344615c34254f9da937cffb84d95bb7fce4c0ee))
* add documentation for RESTART_TIME ([1009ce6](https://github.com/BndktCG/streetmerchant/commit/1009ce6636c21c378121bd83b251a371a1b8568e))
* add hyperlinks ([ca2580d](https://github.com/BndktCG/streetmerchant/commit/ca2580d72b8f232d4630bd7dc666d0d8314b7e54))
* add information around 3060 ([#2031](https://github.com/BndktCG/streetmerchant/issues/2031)) ([69e0059](https://github.com/BndktCG/streetmerchant/commit/69e005905ae38e6cd1fe37d7588b472556cf164d))
* add missing `font` key ([0c80d6c](https://github.com/BndktCG/streetmerchant/commit/0c80d6caeae03c0bb2a7db0d80e49129ce9b53d6))
* add terraform reference ([fbb024a](https://github.com/BndktCG/streetmerchant/commit/fbb024a9cefa34e3291c060c39951b4cc66760d5))
* add terraform to mkdocs ([488bc54](https://github.com/BndktCG/streetmerchant/commit/488bc544c98c3f69013f02ba77cae414cc516faf)), closes [#1987](https://github.com/BndktCG/streetmerchant/issues/1987)
* change 3090 to 4090 ([dccaa52](https://github.com/BndktCG/streetmerchant/commit/dccaa52ce99125740fcfdf3c9a71bdf261574097))
* change fonts to Roboto ([272b49b](https://github.com/BndktCG/streetmerchant/commit/272b49b4ac10f1c3d92ae748679bd6a184893164))
* **discord:** add xbox* groups ([0d75025](https://github.com/BndktCG/streetmerchant/commit/0d75025cbb2cad2577954eebf20a6e6c46e6cb6b)), closes [#1352](https://github.com/BndktCG/streetmerchant/issues/1352)
* **filter:** update El Corte Inglés location ([#1369](https://github.com/BndktCG/streetmerchant/issues/1369)) ([db47827](https://github.com/BndktCG/streetmerchant/commit/db47827e6e70e0a0e02a8f4ed30ef8c3372bcb96))
* fix badge ([bb01bed](https://github.com/BndktCG/streetmerchant/commit/bb01bedb037d4230c85a7fe59ce40ef7e29ea5a1))
* fix badge link ([9d5af9f](https://github.com/BndktCG/streetmerchant/commit/9d5af9f8f9cda7e12fb19575be4b7805c65a77cd))
* fix banner location ([a9b2ecf](https://github.com/BndktCG/streetmerchant/commit/a9b2ecfd48fed0c33302dc10e97658c726940a52))
* fix hotlink ([8db16dd](https://github.com/BndktCG/streetmerchant/commit/8db16dd0cb64c1da5a42a2b5b2a1696926a3e599))
* fix sort-able tables ([08789a7](https://github.com/BndktCG/streetmerchant/commit/08789a70c4b9e76000f881edda35acd07bdd60b9))
* fix spelling in "Creating a Discord webhook" ([#1646](https://github.com/BndktCG/streetmerchant/issues/1646)) ([943ab83](https://github.com/BndktCG/streetmerchant/commit/943ab837e2e4dd55700a6a7c204a0871647fcfaa))
* include max prices for adding a store ([7e3020a](https://github.com/BndktCG/streetmerchant/commit/7e3020a927edbe9381e4a75df29b5bb8aeaffcc7))
* make templates required ([00b468a](https://github.com/BndktCG/streetmerchant/commit/00b468a73832b959e0c6ac1ed67b0b23856db76b))
* medimax is de store ([5786481](https://github.com/BndktCG/streetmerchant/commit/5786481b31e4d354fffc0af4eea3117907056394))
* **reference:** add AMD 6800, 6800xt, 6900xt ([#1463](https://github.com/BndktCG/streetmerchant/issues/1463)) ([70b2e7c](https://github.com/BndktCG/streetmerchant/commit/70b2e7c4084fd63e268d29374a6f2f4226f0a6e0))
* **reference:** add AWD-IT ([#1460](https://github.com/BndktCG/streetmerchant/issues/1460)) ([673b5f3](https://github.com/BndktCG/streetmerchant/commit/673b5f325c10cf30feed9b166a2b93980db38d34))
* remove badges ([4388e9a](https://github.com/BndktCG/streetmerchant/commit/4388e9a5e0cb1d1e544b5614fdba37efc2475d52))
* remove twitter ([d19d05c](https://github.com/BndktCG/streetmerchant/commit/d19d05c2e5d4e6e20085116177e4320f74ddfe54))
* remove twitter ([1aa0224](https://github.com/BndktCG/streetmerchant/commit/1aa0224da0718a8058996511f73c672938a231fb))
* **store:** add missing uk store ([#1384](https://github.com/BndktCG/streetmerchant/issues/1384)) ([2d25c46](https://github.com/BndktCG/streetmerchant/commit/2d25c464f88802194d81dd5c5639d821c0f67583))
* toggle light/dark mode ([1e76d5a](https://github.com/BndktCG/streetmerchant/commit/1e76d5a270e7fb678ccea3649b38f323b346d702))
* **twitch:** add instructions on how to get tokens ([9c35e72](https://github.com/BndktCG/streetmerchant/commit/9c35e728ac450838878b73394acbe12bfd34d55c))
* update badge ([42808b8](https://github.com/BndktCG/streetmerchant/commit/42808b836cd8c9d0fc19f81dbceaab825f864d36))
* update badges ([82cafc4](https://github.com/BndktCG/streetmerchant/commit/82cafc4135bb94abddfb8677703a9306010e0db3))
* update badges ([c2c8531](https://github.com/BndktCG/streetmerchant/commit/c2c8531ea26e2b75f50ed384f5128e5df54053e9))
* update badges ([0730689](https://github.com/BndktCG/streetmerchant/commit/07306891d7e2f286ac957841e6ddf6d654c2820e))
* update docker-compose information ([da78362](https://github.com/BndktCG/streetmerchant/commit/da78362045bde23717d2c389ea18f14119a41d6c))
* update docker-compose title ([e2bf574](https://github.com/BndktCG/streetmerchant/commit/e2bf5749c1936ac71797fcd8a27f0bf2e31df653))
* update edit_uri location ([af603c2](https://github.com/BndktCG/streetmerchant/commit/af603c20aed49e01fc6923b1be1759a74575c12f))
* update format for models and countries ([68eede5](https://github.com/BndktCG/streetmerchant/commit/68eede5487878e30a4b8689ccc84f411f9e837a1))
* update incorrect store description for alternate-de ([#2765](https://github.com/BndktCG/streetmerchant/issues/2765)) ([28ce7e9](https://github.com/BndktCG/streetmerchant/commit/28ce7e995b6ea521f03ed5845387aa3858a34f72))
* update issue templates ([74d71e4](https://github.com/BndktCG/streetmerchant/commit/74d71e457956743566796404458bd1d5d84598db))
* update issue templates ([9aa3f16](https://github.com/BndktCG/streetmerchant/commit/9aa3f164a59cd521701f55bfe4a54872b1c5fc4d))
* update issue templates ([7171113](https://github.com/BndktCG/streetmerchant/commit/71711131ff4c57abe3016e543b7d0ce994e0ecd0))
* update mkdocs appearance ([38630d4](https://github.com/BndktCG/streetmerchant/commit/38630d478a4d66a984d9317379a53b522a21a8f7))
* update node references ([f65aab8](https://github.com/BndktCG/streetmerchant/commit/f65aab87dade27c9f271ca816f83fe5a57ff7da6))
* update Xbox Series S and X price limit desc ([#2098](https://github.com/BndktCG/streetmerchant/issues/2098)) ([ba35706](https://github.com/BndktCG/streetmerchant/commit/ba35706cca84a425da8d5a5bd6b86dbecbadffa1))
* use main branch for badge ([8dab4bb](https://github.com/BndktCG/streetmerchant/commit/8dab4bb1e3441493a809c603b078c69777fbd8ff))
* use node lts ([2a482e3](https://github.com/BndktCG/streetmerchant/commit/2a482e3dfaaeaa2f285b98d32d67d44bdd4ef6f4)), closes [#2776](https://github.com/BndktCG/streetmerchant/issues/2776)


### Refactoring

* **captcha:** use seconds instead of ms ([#2424](https://github.com/BndktCG/streetmerchant/issues/2424)) ([d652b49](https://github.com/BndktCG/streetmerchant/commit/d652b4936435377d36268141a2b63c8798f7f95b))
* change `.env` to be `dotenv` ([#1341](https://github.com/BndktCG/streetmerchant/issues/1341)) ([9b3906c](https://github.com/BndktCG/streetmerchant/commit/9b3906ca0046cc3c1fa977bf1b406b224d675bba))
* **freemobile:** remove local throw ([bf8f242](https://github.com/BndktCG/streetmerchant/commit/bf8f242f4b33796fcee91a863f0e086fcec29537))
* make link labels &gt; store labels ([f583029](https://github.com/BndktCG/streetmerchant/commit/f583029bf31e6bcec8b535a1fe088fa464771183))
* **materiel:** update docs, change name ([7ec8a16](https://github.com/BndktCG/streetmerchant/commit/7ec8a160cf9844df34578fe9f413b88d6141178c))
* simplify maxPrice logic ([a25b7f1](https://github.com/BndktCG/streetmerchant/commit/a25b7f19cc8e403ffd7856e631cde7e9df63f1cc))
* **store:** replace euroFormat with regex ([#2131](https://github.com/BndktCG/streetmerchant/issues/2131)) ([795c723](https://github.com/BndktCG/streetmerchant/commit/795c7230ad4632c81b17f5c2aeb3b0e88b2b04e3))
* use gts instead of xo ([f87053c](https://github.com/BndktCG/streetmerchant/commit/f87053cb02e04b3cb2c0cf253187a9e9857c9858))
